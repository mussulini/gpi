                        ...
                        <div class="row row-grid">
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <h6 class="text-primary text-uppercase">Download GPI</h6>
                                    <p class="description mt-3">GPI is a great free UI package based on Bootstrap 4
                            ...
                            <div class="col-lg-4">
                                <card class="border-0" hover shadow body-classes="py-5">
                                    ...
                                    <p class="description mt-3">GPI is a great free UI package based on Bootstrap
                ...
                <div class="row row-grid justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <p class="lead">Cause if you do, it can be yours for FREE. Hit the button below to navigate to
                            Gameplay Interactive where you can find the Design System in HTML. Start a new project or give an
