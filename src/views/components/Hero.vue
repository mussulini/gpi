            ...
            <div class="col px-0">
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-7 text-center pt-lg">
                        <img src="img/brand/logo-lt.png" style="width: 200px;" class="img-fluid">
                ...
                <div class="row align-items-center justify-content-around stars-and-coded">
                    ...
                    <div class="col-sm-4 mt-4 mt-sm-0 text-right">
                        ...
                        <a href="/" target="_blank" title="Gameplay Interactive - Premium Bootstrap Themes and Templates">
                            <img src="img/brand/logo-lt.png" class="ml-3" style="height: 30px;">
                        </a>
                    </div>
                </div>
            </div>
