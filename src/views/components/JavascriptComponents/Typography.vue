<template>
    <div>
        ...
        <div class="row py-3 align-items-center">
            ...
            <div class="col-sm-9">
                <h1 class="mb-0">GPI Design System</h1>
            </div>
        </div>
        <div class="row py-3 align-items-center">
            <div class="col-sm-3">
            ...
            <div class="col-sm-9">
                <h2 class="mb-0">GPI Design System</h2>
            </div>
        </div>
        <div class="row py-3 align-items-center">
            <div class="col-sm-3">
            ...
            <div class="col-sm-9">
                <h3 class="mb-0">GPI Design System</h3>
            </div>
        </div>
        <div class="row py-3 align-items-center">
            <div class="col-sm-3">
            ...
            <div class="col-sm-9">
                <h4 class="mb-0">GPI Design System</h4>
            </div>
        </div>
        <div class="row py-3 align-items-center">
            <div class="col-sm-3">
            ...
            <div class="col-sm-9">
                <h5 class="mb-0">GPI Design System </h5>
            </div>
        </div>
        <div class="row py-3 align-items-center">
            <div class="col-sm-3">
            ...
            <div class="col-sm-9">
                <h6 class="mb-0">GPI Design System </h6>
            </div>
        </div>
        <!-- Display titles -->
        ...
        <div class="row py-3 align-items-center">
            ...
            <div class="col-sm-9">
                <h1 class="display-1 mb-0">GPI Design System</h1>
            </div>
        </div>
        <div class="row py-3 align-items-center">
            <div class="col-sm-3">
            ...
            <div class="col-sm-9">
                <h2 class="display-2 mb-0">GPI Design System</h2>
            </div>
        </div>
        <div class="row py-3 align-items-center">
            <div class="col-sm-3">
            ...
            <div class="col-sm-9">
                <h3 class="display-3 mb-0">GPI Design System</h3>
            </div>
        </div>
        <div class="row py-3 align-items-center">
            <div class="col-sm-3">
            ...
            <div class="col-sm-9">
                <h4 class="display-4 mb-0">GPI Design System</h4>
            </div>
        </div>
        <!-- Specialized titles -->
        ...
        <div class="row py-3 align-items-center">
            ...
            <div class="col-sm-9">
                <h3 class="heading mb-0">GPI Design System</h3>
            </div>
        </div>
        <div class="row py-3 align-items-center">
            <div class="col-sm-3">
            ...
            <div class="col-sm-9">
                <h3 class="heading-title text-warning mb-0">GPI Design System</h3>
            </div>
        </div>
        <div class="row py-3 align-items-center">
            <div class="col-sm-3">
