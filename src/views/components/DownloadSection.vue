        ...
        <div class="container">
            <div class="row row-grid justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    <p class="lead">Cause if you do, it can be yours for FREE. Hit the button below to navigate to Gameplay Interactive where you can find the Design System in HTML. Start a new project or give an old Bootstrap project a new look!</p>
                    <div class="btn-wrapper">
                        <a href="" class="btn btn-primary mb-3 mb-sm-0">Download Vue</a>
                    </div>
